...
namespace Tests.Restbucks.Quoting.Service.Resources
{
    ...
    public class OrderFormTests
    {
        ...
        public void ShouldBaseOrderFormOnQuoteFromQuoteEngine()
        {
            ...
            var result = orderForm.Get(id.ToString("N"), request, new HttpResponseMessage());
        ...
        public void FormContentsShouldIncludeSelfLinkForQuote()
        {
            ...
            Assert.AreEqual(DefaultUriFactoryCollection.Instance.For<Quote>().CreateRelativeUri(id.ToString("N")), formContents.Links.Single(l => l.Rels.First().Value.Equals("self")).Href.ToString());
        }
        ...
        public void ShouldIncludeContentLocationHeaderPointingToUnderlyingQuoteResource()
        {
            ...
            Assert.AreEqual(DefaultUriFactoryCollection.Instance.For<Quote>().CreateAbsoluteUri(BaseAddress, id.ToString("N")), result.Response.Content.Headers.ContentLocation.ToString());
        }
        ...
        {
            return new HttpRequestMessage { RequestUri = DefaultUriFactoryCollection.Instance.For<OrderForm>().CreateAbsoluteUri(BaseAddress, id.ToString("N")) };
        }
