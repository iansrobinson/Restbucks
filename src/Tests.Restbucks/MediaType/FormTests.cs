...
namespace Tests.Restbucks.MediaType
{
    ...
    public class FormTests
    {
        ...
        {
            new Form(null, "post", "application/xml", new Uri("http://localhost"), new Shop());
        }
        ...
        {
            new Form(new Uri("http://localhost"), null, "application/xml", new Uri("http://localhost"), new Shop());
        }
        ...
        {
            new Form(new Uri("http://localhost"), " ", "application/xml", new Uri("http://localhost"), new Shop());
        }
        ...
        {
            new Form(new Uri("http://localhost"), "post", null, new Uri("http://localhost"), new Shop());
        }
        ...
        {
            new Form(new Uri("http://localhost"), "post", " ", new Uri("http://localhost"), new Shop());
        }

        [Test]
        public void AllowsNullSchema()
        {
            Assert.IsInstanceOf<Form>(new Form(new Uri("http://localhost"), "post", "application/xml", null, new Shop()));
        }
