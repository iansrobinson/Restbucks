...
namespace Tests.Restbucks.Client.RulesEngine
{
    ...
    public class RuleTests
    {
        ...
        {
            var rule1 = new Rule(() => true, typeof (DummyResponseHandler), "context-name", (h, c, r) => null);
            Assert.IsTrue(rule1.IsApplicable);

            var rule2 = new Rule(() => false, typeof (DummyResponseHandler), "context-name", (h, c, r) => null);
